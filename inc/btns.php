...
function wpac_like_dislike_buttons( $content ) {
	...
	if ( is_single() ) {
		...
		$like_btn        .= '<a href="javascript:" onclick="wpac_like_btn_ajax(' . $post_id
		                    . ')" class="wpac-btn wpac-like-btn wpac-flat-btn">';

		if ( $like_dislike_count == "on" ) {
			$like_btn .= '<span class="wpac-btn-icon"><i class="fas fa-thumbs-up"></i><span id="wpacLikeCount">'
		...
		$dislike_btn .= '<a href="javascript:" onclick="wpac_dislike_btn_ajax(' . $post_id
		                . ')" class="wpac-btn wpac-dislike-btn wpac-flat-btn">';

		if ( $like_dislike_count == "on" ) {
			$dislike_btn .= '<span class="wpac-btn-icon"><i class="fas fa-thumbs-down"></i><span id="wpacDislikeCount">'
			                . $dislike_count . '</span></span>';
		} else {
		...
		$wpac_vs_progress_bar = '<div class="wpac-vs-bar-container"><div id="wpac-vsBar-likes" style="width:'
		                        . $like_percent . '%">' . $like_percent . '% ' . $like_btn_label
		                        . '<span class="wpac-bar-vs-badge">VS</span></div><div id="wpac-vsBar-dislikes" style="width:'
		                        . $dislike_percent . '%">' . $dislike_percent . '% ' . $dislike_btn_label
		                        . '</div></div>';
