...
function wpac_save_reaction_ajax_action() {
    ...
    if(isset($_POST['pid']) && isset($_POST['uid']) && wpac_check_post_id($_POST['pid']) && wpac_check_user($_POST['uid']) && wpac_check_user($_POST['rid'])) {
        ...
        if($user_id){
            ...
            _e("You need to login to react to this post","wpaclike");
        }
